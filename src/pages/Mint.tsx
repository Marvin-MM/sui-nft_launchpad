...
export default function Mint() {
  ...
  const handleMint = async () => {
    ...
    try {
      ...
      if (mintStrategy === 'dutch') {
        tx.moveCall({
          target: `${PACKAGE_ID}::mint::mint_dutch`,
          arguments: [
        ...
        tx.moveCall({
          target: `${PACKAGE_ID}::mint::commit_mint`,
          arguments: [
            tx.object(MINT_CONFIG_ID),
            feeCoin,
            tx.pure.u64(quantity),
  ...
  return (
    <div className="max-w-[1600px] mx-auto min-h-screen border-x border-white/10 grid grid-cols-1 lg:grid-cols-12">
      ...
      <div className="lg:col-span-8 p-12 lg:p-24 space-y-24 border-b lg:border-b-0 lg:border-r border-white/10">
        <div className="space-y-8">
          <div className="flex items-center gap-4 text-emerald-500">
             <Activity className="w-4 h-4" />
             <span className="text-[10px] font-medium tracking-[0.4em] uppercase">SYSTEM_NODE: ACTIVE</span>
          </div>
          <h1 className="text-7xl md:text-[120px] font-light leading-[0.8] tracking-[-0.05em] uppercase">
            ASSET<br />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 divide-y md:divide-y-0 md:divide-x divide-white/10 border border-white/10 bg-white/1">
           ...
           <div className="p-10 space-y-12 bg-white/1">
              <div className="space-y-6">
      ...
      <div className="lg:col-span-4 p-12 lg:p-24 space-y-12 bg-white/1">
        <AIAdvisor />
      ...
      <AnimatePresence>
        {showCelebration && mintedNft && (
          ...
          >
            ...
            >
              <div className="aspect-square border-r border-white/10 p-12 bg-white/1">
                 <img 
                   src={mintedNft.image} 
                   alt={mintedNft.name} 
              ...
              <div className="p-12 lg:p-24 flex flex-col justify-between space-y-12">
                 <div className="space-y-8">
                    ...
                    <div className="space-y-2">
                       <h2 className="text-6xl font-light tracking-tighter uppercase leading-none">{mintedNft.name}</h2>
